...
struct SearchSuccessItem: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading){
            ...
            Text(saleProduct?.title ?? " title").lineLimit(2).padding(5)
...
struct SearchSuccessItem_Previews: PreviewProvider {
    static var previews: some View {
        SearchSuccessItem().previewLayout(.sizeThatFits)
    }
}
